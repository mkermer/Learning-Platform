...
function TermsOfService() {
        ...
        return (
            <div className="Text">
                        ...
                        <p className="adsimple-121612670">CO2 - Treeduce<br />Example Street 123, /4, <br />1234 Vienna, <br />Austria</p>
                        <p className="adsimple-121612670">
                        <strong>Object of the company:</strong> Gardening<br />
                        <strong>VAT-Number:</strong> ATU12345678<br />
                        <strong>Corporate register number:</strong> 123456a<br />
                        <strong>Corporate register court:</strong> Vienna<br />
                        <strong>Company location:</strong> 1234 Vienna</p>
                        <p className="adsimple-121612670">
                        <strong>Phone:</strong> 01234/56789<br />
                        <strong>Fax:</strong> 01234/56789-0<br />
                        <strong>Email:</strong> <a href="mailto:office@co2-treeduce.com">office@co2-treeduce.com</a>
                        </p>
                        <p className="adsimple-121612670">
                        <strong>Member of:</strong> WKO<br />
                        <strong>Laws re. professions:</strong> www.ris.bka.gv.at</p>
                        <p className="adsimple-121612670">
                        <strong>Supervisory/Trade authority:</strong> Vienna<br />
                        <strong>Job title:</strong> Gardener<br />
                        <strong>Awarding country:</strong> Austria</p>
                        <p className="adsimple-121612670">
                        <strong>Chief executive</strong>
                        <br />Adrian Fabjanski, Johanna von Horn, Morgane Kermer, Yuliya Kalcheva</p>
                        <p>Source: Created with the Impressum Generator by <a href="https://www.adsimple.at/webdesign/" title="AdSimple® Online Marketing and Webdesign" target="_blank" rel="noopener noreferrer">AdSimple® Webdesign</a> in cooperation with <a href="https://www.aboutbusiness.at/" target="_blank" rel="noopener noreferrer" >aboutbusiness.at</a>
                        </p>
                        <h2 id="eu-streitschlichtung-en" className="adsimple-121612670">
                        </h2>
                        <h2 id="haftung-fuer-inhalte-dieser-webseite-en" className="adsimple-121612670">
                        </h2>
                        <h2 id="haftung-links-webseite-en" className="adsimple-121612670">
                        </h2>
                        <h2 id="urheberrechtshinweis-en" className="adsimple-121612670">
                        </h2>
                        <h2 id="bildernachweis-en" className="adsimple-121612670">
                        </h2>
                        <h1 className="adsimple-121612670">Privacy policy</h1>
                        ...
                        <li>
                        <a href="#facebook-pixel-datenschutzerklaerung-en">Facebook Pixel Privacy Policy</a>
                        </li>
                        <li>
                        <a href="#facebook-datenschutzerklaerung-en">Facebook Data Policy</a>
                        </li>
                        <li>
                        <a href="#instagram-datenschutzerklaerung-en">Instagram Privacy Policy</a>
                        </li>
                        <li>
                        <a href="#twitter-datenschutzerklaerung-en">Twitter Privacy Policy</a>
                        </li>
                        <li>
                        <a href="#klarna-checkout-datenschutzerklaerung-en">Klarna Checkout Privacy Policy</a>
                        </li>
                        <li>
                        <a href="#sofortueberweisung-datenschutzerklaerung-en">Sofortüberweisung Privacy Policy</a>
                        </li>
                        <li>
                        <a href="#bootstrapcdn-datenschutzerklaerung-en">BootstrapCDN Privacy Policy</a>
                        </li>
                        </ul>
                        <h2 id="datenschutz-en" className="adsimple-121612670">Privacy Policy</h2>
                        <p>We created this Privacy Policy (version 01.01.1970-121612670), to declare which information we collect, how we use data and which options the users of our website have, according to the guidelines of the <a className="adsimple-121612670" href="https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=celex%3A32016R0679&amp%3Btid= 121612670" target="_blank" rel="noopener noreferrer">General Data Protection Regulation (EU) 2016/679</a>
                        </p>
                        ...
                        <h2 id="automatische-datenspeicherung-en" className="adsimple-121612670">Automatic Data Retention</h2>
                        ...
                        <ul className="adsimple-121612670">
                        <li className="adsimple-121612670">the address (URL) of the accessed website</li>
                        <li className="adsimple-121612670">browser and browser version</li>
                        <li className="adsimple-121612670">the used operating system</li>
                        <li className="adsimple-121612670">the address (URL) of the previously visited site (referrer URL)</li>
                        <li className="adsimple-121612670">the host name and the IP-address of the device the website is accessed from</li>
                        <li className="adsimple-121612670">date and time</li>
                        </ul>
                        ...
                        <h2 id="cookies-en" className="adsimple-121612670">Cookies</h2>
                        ...
                        <h3 className="adsimple-121612670">What exactly are cookies?</h3>
                        ...
                        <p>
                        <strong className="adsimple-121612670">name:</strong> _ga<br />
                        <strong className="adsimple-121612670">value:</strong> GA1.2.1326744211.152121612670-9<br />
                        <strong className="adsimple-121612670">purpose:</strong> differentiation between website visitors<br />
                        <strong className="adsimple-121612670">expiration date:</strong> after 2 years</p>
                        <p>A browser should support these minimum sizes:</p>
                        <ul className="adsimple-121612670">
                        <li className="adsimple-121612670">at least 4096 bytes per cookie</li>
                        <li className="adsimple-121612670">at least 50 cookies per domain</li>
                        <li className="adsimple-121612670">at least 3000 cookies in total</li>
                        </ul>
                        <h3 className="adsimple-121612670">Which types of cookies are there?</h3>
                        ...
                        <p>
                        <strong className="adsimple-121612670">Essential Cookies<br />
                        </strong>These cookies are necessary to ensure the basic function of a website. They are needed when a user for example puts a product into their shopping cart, then continues surfing on different websites and comes back later in order to proceed to the checkout. Even when the user closed their window priorly, these cookies ensure that the shopping cart does not get deleted.</p>
                        <p>
                        <strong className="adsimple-121612670">Purposive Cookies<br />
                        ...
                        <p>
                        <strong className="adsimple-121612670">Target-orientated Cookies<br />
                        ...
                        <p>
                        <strong className="adsimple-121612670">Advertising Cookies<br />
                        ...
                        <h3 className="adsimple-121612670">How can I delete cookies?</h3>
                        ...
                        <p>
                        <a className="adsimple-121612670" href="https://support.google.com/chrome/answer/95647?tid=121612670" target="_blank" rel="noopener noreferrer"> Chrome: Clear, enable and manage cookies in Chrome </a>
                        </p>
                        <p>
                        <a className="adsimple-121612670" href="https://support.apple.com/en-gb/guide/safari/sfri11471/mac?tid=121612670" target="_blank" rel="noopener noreferrer"> Safari: Manage cookies and website data in Safari </a>
                        </p>
                        <p>
                        <a className="adsimple-121612670" href=" https://support.mozilla.org/en-US/kb/clear-cookies-and-site-data-firefox?tid=121612670" target="_blank" rel="noopener noreferrer"> Firefox: Clear cookies and site data in Firefox </a>
                        </p>
                        <p>
                        <a className="adsimple-121612670" href=" https://support.microsoft.com/en-gb/help/17442/windows-internet-explorer-delete-manage-cookies?tid=121612670" target="_blank" rel="noopener noreferrer"> Internet Explorer: Delete and manage cookies </a>
                        </p>
                        <p>
                        <a className="adsimple-121612670" href=" https://support.microsoft.com/en-gb/help/4027947/microsoft-edge-delete-cookies?tid=121612670" target="_blank" rel="noopener noreferrer"> Microsoft Edge: Delete cookies in Microsoft Edge </a>
                        </p>
                        ...
                        <h3 className="adsimple-121612670">How is my data protected?</h3>
                        ...
                        <p>If you want to learn more about cookies and do not mind technical documentation, we recommend <a className="adsimple-121612670" href="https://tools.ietf.org/html/rfc6265" target="_blank" rel="noopener noreferrer">https://tools.ietf.org/html/rfc6265</a>, the Request for Comments of the Internet Engineering Task Force (IETF) called “HTTP State Management Mechanism”.</p>
                        <h2 id="speicherung-persoenlicher-daten-en" className="adsimple-121612670">Storage of Personal Data</h2>
                        ...
                        <h2 id="rechte-dsgvo-en" className="adsimple-121612670">Rights in accordance with the General Data Protection Regulation</h2>
                        <p>You are granted the following rights in accordance with the provisions of the <a className="adsimple-121612670" href="https://gdpr-info.eu/" target="_blank" rel="noopener noreferrer">GDPR</a> (General Data Protection Regulation) and the Austrian <a className="adsimple-121612670" href="https://www.ris.bka.gv.at/Dokumente/Erv/ERV_1999_1_165/ERV_1999_1_165.html" target="_blank" rel="noopener noreferrer">Data Protection Act (DSG)</a>:</p>
                        <ul className="adsimple-121612670">
                        <li className="adsimple-121612670">right to rectification (article 16 GDPR)</li>
                        <li className="adsimple-121612670">right to erasure (“right to be forgotten“) (article 17 GDPR)</li>
                        <li className="adsimple-121612670">right to restrict processing (article 18 GDPR)</li>
                        <li className="adsimple-121612670">righ to notification – notification obligation regarding rectification or erasure of personal data or restriction of processing (article 19 GDPR)</li>
                        <li className="adsimple-121612670">right to data portability (article 20 GDPR)</li>
                        <li className="adsimple-121612670">Right to object (article 21 GDPR)</li>
                        <li className="adsimple-121612670">right not to be subject to a decision based solely on automated processing – including profiling – (article 22 GDPR)</li>
                        </ul>
                        <p>If you think that the processing of your data violates the data protection law, or that your data protection rights have been infringed in any other way, you can lodge a complaint with your respective regulatory authority. For Austria this is the data protection authority, whose website you can access at <a className="adsimple-121612670" href="https://www.data-protection-authority.gv.at/?tid=121612670">https://www.data-protection-authority.gv.at/</a>.</p>
                        <h2 id="google-fonts-datenschutzerklaerung-en" className="adsimple-121612670">Google Fonts Privacy Policy</h2>
                        ...
                        <h3 className="adsimple-121612670">What are Google Fonts?</h3>
                        <p>Google Fonts (previously Google Web Fonts) is a list of over 800 fonts which <a href="https://en.wikipedia.org/wiki/Google?tid=121612670">Google</a> LLC provides its users for free.</p>
                        ...
                        <h3 className="adsimple-121612670">Why do we use Google Fonts on our website?</h3>
                        ...
                        <h3 className="adsimple-121612670">Which data is saved by Google?</h3>
                        ...
                        <h3 className="adsimple-121612670">How long and where is the data stored?</h3>
                        ...
                        <h3 className="adsimple-121612670">How can I delete my data or prevent it being stored?</h3>
                        <p>The data Google stores for either a day or a year cannot be deleted easily. Upon opening the page this data is automatically transmitted to Google. In order to clear the data ahead of time, you have to contact Google’s support at <a className="adsimple-121612670" href="https://support.google.com/?hl=en-GB&tid=121612670">https://support.google.com/?hl=en-GB&tid=121612670</a>. The only way for you to prevent the retention of your data is by not visiting our website.</p>
                        <p>Unlike other web fonts, Google offers us unrestricted access to all its fonts. Thus, we have a vast sea of font types at our disposal, which helps us to get the most out of our website. You can find out more answers and information on Google Fonts at <a className="adsimple-121612670" href="https://developers.google.com/fonts/faq?tid=121612670">https://developers.google.com/fonts/faq?tid=121612670</a>. While Google does address relevant elements on data protection at this link, it does not contain any detailed information on data retention.<br />
                        It proofs rather difficult to receive any precise information on stored data by Google.</p>
                        <p>On <a className="adsimple-121612670" href="https://policies.google.com/privacy?hl=de&tid=121612670">https://policies.google.com/privacy?hl=en-GB</a> you can read more about what data is generally collected by Google and what this data is used for.</p>
                        <h2 id="facebook-pixel-datenschutzerklaerung-en" className="adsimple-121612670">Facebook Pixel Privacy Policy</h2>
                        ...
                        <p>In the following we will show you the cookies, which were set on a test page through the integration of the Facebook pixel. Please consider that these cookies are only examples. Depending on the interaction that is made on our website, different cookies are set.</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> _fbp<br />
                        <strong className="adsimple-121612670">Value:</strong> fb.1.1568287647279.257405483-6121612670-7<br />
                        <strong className="adsimple-121612670">Purpose:</strong> Dieses Cookie verwendet Facebook, um Werbeprodukte anzuzeigen.<br />
                        <strong className="adsimple-121612670">Expiration date:</strong> nach 3 Monaten</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> fr<br />
                        <strong className="adsimple-121612670">Value:</strong> 0aPf312HOS5Pboo2r..Bdeiuf…1.0.Bdeiuf.<br />
                        <strong className="adsimple-121612670">Purpose:</strong> Dieses Cookie wird verwendet, damit Facebook-Pixel auch ordentlich funktioniert.<br />
                        <strong className="adsimple-121612670">Expiration date:</strong> nach 3 Monaten</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> comment_author_50ae8267e2bdf1253ec1a5769f48e062121612670-3<br />
                        <strong className="adsimple-121612670">Value:</strong> Name of the author<br />
                        <strong className="adsimple-121612670"> Purpose:</strong> This cookie saves the text and name of a user who e.g. leaves a comment.<br />
                        <strong className="adsimple-121612670"> Expiration date:</strong> after 12 months</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> comment_author_url_50ae8267e2bdf1253ec1a5769f48e062<br />
                        <strong className="adsimple-121612670"> Value:</strong> https%3A%2F%2Fwww.testseite…%2F (URL of the author)<br />
                        <strong className="adsimple-121612670"> Purpose:</strong> This cookie saved the URL of the website that the user types into a text box on our website.<br />
                        <strong className="adsimple-121612670"> Expiration date:</strong> after 12 months</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> comment_author_email_50ae8267e2bdf1253ec1a5769f48e062<br />
                        <strong className="adsimple-121612670"> Value:</strong> email address of the author<br />
                        <strong className="adsimple-121612670"> Purpose:</strong> This cookie saves the email address of the user, if they provided it on the website.<br />
                        <strong className="adsimple-121612670"> Expiration date:</strong> after 12 months</p>
                        <p>
                        <strong className="adsimple-121612670">Note: </strong>The above-mentioned cookies relate to an individual user behaviour. Moreover, especially concerning the usage of cookies, changes at Facebook can never be ruled out.</p>
                        <p>If you are registered at Facebook, you can change the settings for advertisements yourself at <a className="adsimple-121612670" href="https://www.facebook.com/ads/preferences/?entry_product=ad_settings_screen" target="_blank" rel="noopener noreferrer">https://www.facebook.com/ads/preferences/?entry_product=ad_settings_screen</a>. If you are not a Facebook user, you can manage your user based online advertising at <a className="adsimple-121612670" href="https://www.youronlinechoices.com/uk/your-ad-choices?tid=121612670" target="_blank" rel="noopener noreferrer">https://www.youronlinechoices.com/uk/your-ad-choices</a>. You have the option to activate or deactivate any providers there.</p>
                        <p>If you want to learn more about Facebook’s data protection, we recommend you the view the company’s in-house data policies at <a className="adsimple-121612670" href="https://www.facebook.com/policy.php" target="_blank" rel="noopener noreferrer">https://www.facebook.com/policy.php</a>.</p>
                        <h2 id="facebook-datenschutzerklaerung-en" className="adsimple-121612670">Facebook Data Policy</h2>
                        ...
                        <h3 className="adsimple-121612670">What are Facebook tools?</h3>
                        ...
                        <ul className="adsimple-121612670">
                        <li className="adsimple-121612670">Facebook-Pixel</li>
                        <li className="adsimple-121612670">social plugins (e.g. the “Like” or “Share“ button)</li>
                        <li className="adsimple-121612670">Facebook Login</li>
                        <li className="adsimple-121612670">Account Kit</li>
                        <li className="adsimple-121612670">APIs (application programming interface)</li>
                        <li className="adsimple-121612670">SDKs (Softwart developmept kits)</li>
                        <li className="adsimple-121612670">Plattform-integrations</li>
                        <li className="adsimple-121612670">Plugins</li>
                        <li className="adsimple-121612670">Codes</li>
                        <li className="adsimple-121612670">Specifications</li>
                        <li className="adsimple-121612670">Documentations</li>
                        <li className="adsimple-121612670">Technologies and Services</li>
                        </ul>
                        ...
                        <h3 className="adsimple-121612670">Why do we use Facebook tools on our website?</h3>
                        ...
                        <h3 className="adsimple-121612670">What data is saved by the Facebook tools?</h3>
                        ...
                        <h3 className="adsimple-121612670">How can I delete my data or prevent data retention?</h3>
                        ...
                        <p>Facebook is an active participant in the EU-U.S. Privacy Shield Framework, which regulates correct and secure transfer of personal data. You can find more information at <a className="adsimple-121612670" href="https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC" target="_blank" rel="noopener noreferrer">https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC</a>. We hope we could give you an understanding of the most important information about the use of Facebook tools and data processing. If you want to find out more on how Facebook use your data, we recommend reading the data policies at <a className="adsimple-121612670" href="https://www.facebook.com/about/privacy/update" target="_blank" rel="noopener noreferrer">https://www.facebook.com/about/privacy/update</a>.</p>
                        <h2 id="instagram-datenschutzerklaerung-en" className="adsimple-121612670">Instagram Privacy Policy</h2>
                        ...
                        <h3 className="adsimple-121612670">What is Instagram?</h3>
                        ...
                        <h3 className="adsimple-121612670">Why do we use Instagram on our website?</h3>
                        ...
                        <h3 className="adsimple-121612670">What data is saved by Instagram?</h3>
                        ...
                        <p>We assume data processing on Instagram works the same way as on Facebook. Therefore, if you have an account on Instagram or have visited <a className="adsimple-121612670" href="http://www.instagram.com?tid=121612670" target="_blank" rel="noopener noreferrer">www.instagram.com</a>, Instagram has set at least one cookie. If this is the case, your browser uses the cookie to send information to Instagram, as soon as you come across an Instagram function. No later than 90 days (after matching) the data is deleted or anonymised. Even though we have studied Instagram’s data processing in-depth, we cannot tell for sure what exact data Instagram collects and retains.</p>
                        <p>In the following we will show you a list of the least cookies placed in your browser when click on an Instagram function (e.g. button or an Insta picture). In our test we assume you do not have an Instagram account, since if you would be logged in to your Instagram account, your browser would place significantly more cookies.<br />
                        The following cookies were used in our test:</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>csrftoken<br />
                        <strong className="adsimple-121612670">Value: </strong>“”<br />
                        <strong className="adsimple-121612670"> Purpose: </strong>This cookie is most likely set for security reasons to prevent falsifications of requests. We could not find out more information on it.<br />
                        <strong className="adsimple-121612670"> Expiry date:</strong> after one year</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>mid<br />
                        <strong className="adsimple-121612670"> Value: </strong>“”<br />
                        <strong className="adsimple-121612670">Purpose: </strong>Instagram places this cookie to optimise its own offers and services in- and outside of Instagram. The cookie allocates a unique user ID.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong> after end of session</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> fbsr_121612670124024<br />
                        <strong className="adsimple-121612670">Value: </strong>no information<br />
                        <strong className="adsimple-121612670">Purpose: </strong>This cookie stores the login request of Instagram app users. <strong className="adsimple-121612670">
                        <br />
                        </strong>
                        <strong className="adsimple-121612670">Expiry date: </strong> after end of session</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> rur<br />
                        <strong className="adsimple-121612670">Value: </strong>ATN<br />
                        <strong className="adsimple-121612670">Purpose: </strong> This is an Instagram cookie which guarantees functionality on Instagram.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong> after end of session</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> urlgen<br />
                        <strong className="adsimple-121612670">Value: </strong> 194.96.75.33: 1901:1iEtYv:Y833k2_UjKvXgYe121612670<br />
                        <strong className="adsimple-121612670">Purpose: </strong>This cookie serves Instagram’s marketing purposes.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong> after end of session</p>
                        <p>
                        <strong className="adsimple-121612670">Note:</strong> We do not claim this list to be exhaustive. The cookies that are placed in each individual case, depend on the functions embedded as well as on your use of Instagram.</p>
                        <h3 className="adsimple-121612670">How long and where are these data stored?</h3>
                        ...
                        <p>Instagram is a subsidiary company of Facebook Inc. and Facebook is an active participant in the EU-U.S. Privacy Shield Framework. This framework regulates correct transfer between the USA and the European Union. At <a className="adsimple-121612670" href="https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC" target="_blank" rel="noopener noreferrer">https://www.privacyshield.gov/participant?id=a2zt0000000GnywAAC </a> you can find out more about this. We gave our best to make you familiar with the most important information on data processing by Instagram. At <a className="adsimple-121612670" href="https://help.instagram.com/519522125107875" target="_blank" rel="noopener noreferrer">https://help.instagram.com/519522125107875</a> you can find out more on Instagram’s data policies.</p>
                        <h2 id="twitter-datenschutzerklaerung-en" className="adsimple-121612670">Twitter Privacy Policy</h2>
                        ...
                        <h3 className="adsimple-121612670">What is Twitter?</h3>
                        ...
                        <h3 className="adsimple-121612670">Why do we use Twitter on our website?</h3>
                        ...
                        <h3 className="adsimple-121612670">What data is stored by Twitter?</h3>
                        ...
                        <p>We will now show you which cookies are placed if you are not logged in to Twitter but visit a website with built-in Twitter functions. Please consider this list as an example. We do not claim for this list to be extensive, since the array of cookies always changes and depends on your individual actions with Twitter content.<br />
                        The following cookies have been used in our test:</p>
                        <p>
                        <strong className="adsimple-121612670">Name:</strong> personalization_id<br />
                        <strong className="adsimple-121612670">Value:</strong> “v1_cSJIsogU51SeE121612670”<br />
                        <strong className="adsimple-121612670">Purpose: </strong>This cookie stores information on how you use the website and what ad may have led you to Twitter.</p>
                        <p>
                        <strong className="adsimple-121612670">Expiry date:</strong> after 2 years</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>lang<br />
                        <strong className="adsimple-121612670">Value: </strong>en<br />
                        <strong className="adsimple-121612670">Purpose: </strong>This cookie stores your deafault or preferred language.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong>after end of session</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>guest_id<br />
                        <strong className="adsimple-121612670">Value: </strong>121612670v1%3A157132626<br />
                        <strong className="adsimple-121612670">Purpose: </strong> This cookie is set to identify you as a guest.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong>after 2 years</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>fm<br />
                        <strong className="adsimple-121612670">Value: </strong>0<br />
                        <strong className="adsimple-121612670">Purpose: </strong>Unfortunately, we could not find out the purpose of this cookie.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong>after end of session</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>external_referer<br />
                        <strong className="adsimple-121612670">Value: </strong>1216126702beTA0sf5lkMrlGt<br />
                        <strong className="adsimple-121612670">Purpose: </strong>This cookie collects anonymous data, such as how often you visit Twitter and how long you visit Twitter.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong>after 6 days</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>eu_cn<br />
                        <strong className="adsimple-121612670">Value: </strong>1<br />
                        <strong className="adsimple-121612670">Purpose: </strong>This cookie stores user activity and is used for Twitter’s various advertising purposes.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong>after one year</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>ct0<br />
                        <strong className="adsimple-121612670">Value: </strong>c1179f07163a365d2ed7aad84c99d966<br />
                        <strong className="adsimple-121612670">Purpose: </strong> Unfortunately we could not find any information on this cookie.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong>after 6 hours</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>_twitter_sess<br />
                        <strong className="adsimple-121612670">Value: </strong>53D%253D–dd0248121612670-<br />
                        <strong className="adsimple-121612670">Purpose: </strong>With this cookie you can use functions within Twitter’s website.<br />
                        <strong className="adsimple-121612670">Expiry date: </strong>after end of session</p>
                        <p>
                        <strong className="adsimple-121612670">Note: </strong>Twitter also works with third parties. Therefore, we have recognized the three Google Analytics cookies _ga, _gat, _gid in our test.</p>
                        ...
                        <h3 className="adsimple-121612670">How long and where are the data stored?</h3>
                        ...
                        <p>If you do not have a Twitter account, you can go to <a className="adsimple-121612670" href="https://twitter.com/">twitter.com</a> and click “Settings”. At “Personalization and data” you can manage data that is collected on you.</p>
                        ...
                        <p>Twitter also uses the data for personalised advertising in-and outside of Twitter. You can switch off personalised advertising in the settings under “Personalization and data”. If you use Twitter on a browser, you can deactivate personalised advertising at <a className="adsimple-121612670" href="http://optout.aboutads.info/?c=2&lang=EN" target="_blank" rel="noopener noreferrer">http://optout.aboutads.info/?c=2&lang=EN</a>.</p>
                        <p>Twitter is an active participant in the EU-U.S. Privacy Shield Framework. This framework ensures correct data transmission between the USA and the European Union. You can learn more about it at <a className="adsimple-121612670" href="https://www.privacyshield.gov/participant?id=a2zt0000000TORzAAO" target="_blank" rel="noopener noreferrer">https://www.privacyshield.gov/participant?id=a2zt0000000TORzAAO</a>.</p>
                        <p>We hope we could give you a basic overview of Twitter’s data processing. We do not receive any data from Twitter and are not responsible for what Twitter does with your data. If you have any further questions on this topic, we recommend reading Twitter’s privacy statement at <a className="adsimple-121612670" href="https://twitter.com/en/privacy">https://twitter.com/en/privacy</a>.</p>
                        <h2 id="klarna-checkout-datenschutzerklaerung-en" className="adsimple-121612670">Klarna Checkout Privacy Policy</h2>
                        <p>On our website we use the Klarna Checkout online payment system by the Swedish company Klarna Bank AB. Klarna Bank is headquartered in Sveavägen 46, 111 34 Stockholm, Sweden. If you choose this service, your personal data will be sent to Klarna, where it will be stored and processed. With this privacy policy we want to give you an overview of Klarna’s data processing.</p>
                        <h3 className="adsimple-121612670">What is Klarna Checkout?</h3>
                        <p>Klarna Checkout is a payment system for online shops. The user selects the payment method and Klarna Checkout takes over the entire payment process. Once a user has made payment via the checkout system and provided the relevant data, future online purchases can be made even faster and easier. Klarna’s system then recognises the existing customer after they enter their email address and postcode.</p>
                        <h3 className="adsimple-121612670">Why do we use Klarna Checkout on our website?</h3>
                        <p>It is our goal to offer you the best possible service with our website and our integrated online shop. In addition to the overall website and offer experience this also includes smooth, fast and secure payment processing of your orders. To ensure this, we use the Klarna Checkout payment system.</p>
                        <h3 className="adsimple-121612670">What data is stored by Klarna Checkout?</h3>
                        <p>As soon as you choose Klarna’s payment service and pay using Klarna Checkout, you transmit personal data to the company. On Klarna’s checkout page, technical data such as browser type, operating system, our web address, date and time, your IP address as well as your language and time zone settings are collected and transmitted to Klarna’s servers where they are stored. This data is stored even if you have not yet completed an order at that point.</p>
                        <p>If you order a product or service from our shop, you must enter your personal data in the provided fields. Klarna processes this data for handling the payment. The following personal data (along with general product information) may be stored and processed by Klarna to check your creditworthiness and identity:</p>
                        <ul className="adsimple-121612670">
                        <li className="adsimple-121612670">Contact information: Name, date of birth, national ID number, title, invoice- und shipping address, email address, telephone number, nationality or salary.</li>
                        <li className="adsimple-121612670">Payment information such as credit cards or your account number</li>
                        <li className="adsimple-121612670">Product details such as shipment number, as well as type and price of the product</li>
                        </ul>
                        <p>Furthermore, there are data which may optionally be collected if you have specifically decided for it. These are for example political, religious, or ideological beliefs or various health data.</p>
                        <p>In addition to the data mentioned above, Klarna can also collect data about the goods or services you order. It may also do this via third parties (such as e.g. us or public databases). This can for example be the type or tracking number of the ordered article, but also information on your creditworthiness, as well as your income or loan grants. Klarna can also pass on your personal data to service companies such as software and data storage providers or us as a retailer.</p>
                        <p>Every time data is automatically filled into a form, cookies are involved. If you do not want to use this function, you can deactivate these cookies anytime. Below you will find instructions on how to delete, deactivate or manage cookies in your browser. Our tests have shown that Klarna does not directly place cookies. If you choose the payment method “Klarna Sofort” and click on “Order”, you will be redirected to the “Sofort” website. After successful payment you will land on our thank-you page. There the following cookie is set by sofort.com:</p>
                        <p>
                        <strong className="adsimple-121612670">Name</strong>: SOFUEB<br />
                        <strong className="adsimple-121612670">Value: </strong>e8cipp378mdscn9e17kajlfhv7121612670-4<br />
                        <strong className="adsimple-121612670">Purpose:</strong> This cookie stores your session ID.<br />
                        <strong className="adsimple-121612670">Expiry date:</strong> after ending the browser session</p>
                        <h3 className="adsimple-121612670">How long and where are the data stored?</h3>
                        <p>Klarna strives to store your data only within the EU or the European Economic Area (EEA). However, it can also happen that data is transferred outside the EU/EEA. If this happens, Klarna ensures that the data protection either complies with the GDPR, that the third country is subject to an adequacy decision of the European Union or that the country has the US Privacy Shield certificate. Any data is always stored for as long as Klarna requires it for processing.</p>
                        <h3 className="adsimple-121612670">How can I delete my data or prevent data retention?</h3>
                        <p>You can withdraw your consent for Klarna to process personal data anytime. Moreover, you always have the right for information, rectification, and deletion of your personal data. For this you must simply contact the company or its data protection team by email at <a className="adsimple-121612670" href="mailto:privacy@klarna.co.uk">privacy@klarna.co.uk</a>. You can also contact them directly via <a className="adsimple-121612670" href="https://www.klarna.com/uk/my-privacy-request-form/?tid=121612670" target="_blank" rel="noopener noreferrer">“My Privacy Request”</a> on Klarna’s website.</p>
                        <p>Cookies that Klarna may use for their functions can be deleted, deactivated, or managed in your browser. These settings can vary slightly, depending on the browser you use. The following instructions will show you how to manage cookies in your browser:</p>
                        <p>
                        <a className="adsimple-121612670" href="https://support.google.com/chrome/answer/95647?tid=121612670" target="_blank" rel="noopener noreferrer"> Chrome: Clear, enable and manage cookies in Chrome </a>
                        </p>
                        <p>
                        ...
                        <p>We hope we were able to give you a good overview of Klarna’s data processing. If you want to learn more about the handling of your data, we recommend Klarna’s privacy notice at <a className="adsimple-121612670" href="https://cdn.klarna.com/1.0/shared/content/legal/terms/0/en_gb/privacy?tid=121612670" target="_blank" rel="noopener noreferrer">https://cdn.klarna.com/1.0/shared/content/legal/terms/0/en_gb/privacy</a>.</p>
                        <p> </p>
                        <h2 id="sofortueberweisung-datenschutzerklaerung-en" className="adsimple-121612670">Sofortüberweisung Privacy Policy</h2>
                        <p>On our website we offer the payment method “Sofortüberweisung” from Sofort GmbH for cashless payment. Sofort GmbH has been part of the Swedish company Klarna since 2014, but is based in Germany, Theresienhöhe 12, 80339 Munich.</p>
                        <p>If you choose this payment method, your personal data will also be transmitted to Sofort GmbH or Klarna, where it will be stored and processed. In this privacy policy we will give you an overview of Sofort GmbH’s data processing.</p>
                        <h3 className="adsimple-121612670">What is “Sofortüberweisung”?</h3>
                        <p>Sofortüberweisung is an online payment system that enables you to place an order via online banking. The payment is processed by Sofort GmbH, while we immediately receive information about your payment. Anyone who has an active online banking account with a PIN and TAN can use this method. Only a few banks do not yet support this payment option.</p>
                        <h3 className="adsimple-121612670">Why do we use “Sofortüberweisung” on our website?</h3>
                        <p>It is our goal to offer you the best possible service with our website and our integrated online shop. Next to the overall experience of the website and offers, this also includes smooth, fast, and secure payment processing of your orders. To ensure this, we use “Sofortüberweisung” as a payment system.</p>
                        <h3 className="adsimple-121612670">What data is stored by “Sofortüberweisung”?</h3>
                        <p>If you make an immediate transfer via the Sofort/Klarna service, data such as your name, account number, sort code, payment reference, amount and date are stored on the company’s servers. We then also receive this information via the payment confirmation.</p>
                        <p>As part of the check for sufficient account coverage, Sofort GmbH reviews whether your account balance and overdraft can cover the payment amount. In some cases, it is also reviewed whether any instant transfers have been successfully carried out within the last 30 days. Furthermore, a shortened (“hashed”) form of your user identification (such as your signatory or contract number) as well as your IP address will be stored. For SEPA transfers your BIC and IBAN will also be stored.</p>
                        <p>According to Sofort GmbH, no other personal data (such as account balances, sales data, transaction limits, account lists, mobile phone numbers, authentication certificates, security codes or PIN/TAN) are collected, stored or passed on to third parties.</p>
                        <p>Sofortüberweisung also uses cookies to make our service more user-friendly. When you order a product, you will be redirected to the Sofort or Klarna website. After successful payment you will be redirected to our thank-you page. There, the following three cookies are placed:</p>
                        <p>
                        <strong className="adsimple-121612670">Name</strong>: SOFUEB<br />
                        <strong className="adsimple-121612670">Value: </strong>e8cipp378mdscn9e17kajlfhv7121612670-5<br />
                        <strong className="adsimple-121612670">Purpose:</strong> This cookie stores your session ID.<br />
                        <strong className="adsimple-121612670">Expiry date:</strong> after ending the browser session</p>
                        <p>
                        <strong className="adsimple-121612670">Name</strong>: User[user_cookie_rules]
                        <strong className="adsimple-121612670">Value: </strong>1<br />
                        <strong className="adsimple-121612670">Purpose:</strong> This cookie stores the status of your consent to the use of cookies.<br />
                        <strong className="adsimple-121612670">Expiry date:</strong> after 10 years</p>
                        <p>
                        <strong className="adsimple-121612670">Name: </strong>_ga<br />
                        <strong className="adsimple-121612670">Value: </strong>GA1.2.69759879.1589470706<br />
                        <strong className="adsimple-121612670">Purpose:</strong> Analytics.js uses the _ga cookie by default to store your user ID. Hence, it basically serves to differentiate between website visitors. It is a Google Analytics cookie.<br />
                        <strong className="adsimple-121612670">Expiry date:</strong> after 2 years</p>
                        <p>
                        <strong className="adsimple-121612670">Note:</strong> We do not claim for this cookie list to be exhaustive. Moreover, it is always possible that Sofortüberweisung may also use other cookies.</p>
                        <h3 className="adsimple-121612670">How long and where are the data stored?</h3>
                        <p>All gathered data are stored within the legal storage obligations. This obligation can last between three and ten years.</p>
                        <p>Klarna/Sofort GmbH try to only save data within the EU or the European Economic Area (EEA). If data is transferred outside the EU/EEA, data protection must comply with the GDPR. Also, the country the data is transferred to must be subject to the EU’s adequacy decision or have the US Privacy Shield certificate.</p>
                        <h3 className="adsimple-121612670">How can I delete my data or prevent data retention?</h3>
                        <p>You can withdraw your consent for Klarna to process your personal data at any time. You also always have the right for information, rectification and deletion of your personal data. For this, you can simply email the company’s data protection team at privacy@klarna.co.uk.</p>
                        <p>In your browser, you can manage, delete, or deactivate Sofortüberweisung’s possible cookies. The settings vary a bit depending on what browser you use. The following instructions will show you how to manage cookies in the most common browsers:</p>
                        <p>
                        <a className="adsimple-121612670" href="https://support.google.com/chrome/answer/95647?tid=121612670" target="_blank" rel="noopener noreferrer"> Chrome: Clear, enable and manage cookies in Chrome </a>
                        </p>
                        <p>
                        ...
                        <p>If you want to know more about Sofort GMmbH’s data processing, we recommend the privacy policy at <a className="adsimple-121612670" href=" https://cdn.klarna.com/1.0/shared/content/legal/terms/0/en_gb/privacy?tid=121612670">https://cdn.klarna.com/1.0/shared/content/legal/terms/0/en_gb/privacy</a>.</p>
                        <h2 id="bootstrapcdn-datenschutzerklaerung-en" className="adsimple-121612670">BootstrapCDN Privacy Policy</h2>
                        ...
                        <p>If you want to prevent this data transmission, you can install a JavaScript blocker (for example at <a className="adsimple-121612670" href="https://noscript.net/" target="_blank" rel="noopener noreferrer">https://noscript.net/</a>), or deactivate the execution of JavaScript codes in your browser. However, please note that this means that the website then can no longer offer its usual services (such as fast loading speeds).</p>
                        <p>StackPath is an active participant in the EU-U.S. Privacy Shield Framework, which regulates the correct and secure transfer of personal data. More information on this can be found at <a className="adsimple-121612670" href="https://www.privacyshield.gov/participant?id=a2zt0000000CbahAAC&status=Active" target="_blank" rel="follow noopener noreferrer">https://www.privacyshield.gov/participant?id=a2zt0000000CbahAAC&status=Active</a>.<br />
                        More information on data protection at StackPath or BootstrapCDN can be found at <a className="adsimple-121612670" href="https://www.bootstrapcdn.com/privacy-policy/?tid=121612670" target="_blank" rel="noopener noreferrer">https://www.bootstrapcdn.com/privacy-policy/</a>.</p>
                        <p>Source: Created with the Datenschutz Generator by <a href="https://www.adsimple.at/" title="AdSimple® Online Marketing and Webdesign" rel="noopener noreferrer" target="_blank">AdSimple®</a> in cooperation with <a href="https://www.meinhaushalt.at/" target="_blank" rel="noopener noreferrer">meinhaushalt.at</a>
                        </p>
